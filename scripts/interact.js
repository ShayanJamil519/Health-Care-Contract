...
const contractAddress = "0x59B4EaB484f589c1D6B4032dAD469bBaA74c0EE1";
const contractABI = [
  {
    inputs: [],
...
async function interactWithContract() {
  ...
  const transactionSecond = await contract.getAllUsersData();

  //   console.log("Transaction hash:", transaction.hash);
  console.log("Transaction details2:", transactionSecond);
  console.log("Waiting for the new transaction to be mined...");

  // Wait for the transaction to be mined
  const receiptSecomd = await ganacheProvider.waitForTransaction(
    transactionSecond.hash
  );

  console.log("Transaction mined in block:", receiptSecomd.blockNumber);
}
