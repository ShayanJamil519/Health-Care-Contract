...
contract HealthcareDataTokenVulnerable is ERC20, Ownable {
    ...
    function purchaseData(address _patient) external payable {
        ...
        // purchaseData function in the provided contract is susceptible to the timestamp manipulation vulnerability
        
        // An attacker with control over their node's timestamp can set an arbitrary timestamp to make it appear as if the current time is earlier than the expiration time.
        // This manipulation allows the attacker to purchase data even after it should have expired
